namespace Menees
{
	...
	public static class CsvUtility
	{
		...
		{
			Conditions.RequireReference(writer, nameof(writer));
			Conditions.RequireReference(record, nameof(record));
		...
		{
			Conditions.RequireReference(writer, nameof(writer));
			Conditions.RequireReference(row, nameof(row));
		...
		{
			Conditions.RequireReference(writer, nameof(writer));
			Conditions.RequireReference(table, nameof(table));
