namespace Menees
{
	...
	public static class ReflectionUtility
	{
		...
		{
			Conditions.RequireReference(expression, nameof(expression));
		...
		public static string GetNameOfCaller([CallerMemberName] string callerName = null)
		{
			...
			Conditions.RequireString(callerName, nameof(callerName));
			return callerName;
		}
			...
			switch (expression.NodeType)
			{
				...
				default:
					throw Exceptions.NewArgumentException(
						$"The expression type {expression.NodeType} is not supported for GetNameOf.");
			}
